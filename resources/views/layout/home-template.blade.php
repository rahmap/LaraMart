...
<body>
                  ...
                  <div class="container">
                    ...
                    <div class="menu-item col-sm-3">
                      <div class="menu-content">
                        <a href="#">
                          <img src="{{ asset('shopaholic') }}/images/menu/shop.png" alt="Image">
  ...
  <section class="page-name-sec page-name-sec-01" style="margin-bottom:-250px;">
    <div class="section-padding">
      <div class="container">
        <h3 class="page-title">@yield('descTitle')</h3><!-- /.page-title -->
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
              <div class="widget widget_about_us">
                <a class="footer-logo" href="#"><img src="{{ asset('shopaholic') }}/images/logo2.png" alt="Logo"></a>
            ...
            <div class="col-md-4 col-sm-6">
              <div class="widget widget_instagram_feed">
                ...
                <div class="widget-details">
                  <a href="#"><img src="{{ asset('shopaholic') }}/images/instagram/1.png" alt="Instagram Image"></a>
                  <a href="#"><img src="{{ asset('shopaholic') }}/images/instagram/2.png" alt="Instagram Image"></a>
                  <a href="#"><img src="{{ asset('shopaholic') }}/images/instagram/3.png" alt="Instagram Image"></a>
                  <a href="#"><img src="{{ asset('shopaholic') }}/images/instagram/4.png" alt="Instagram Image"></a>
                  <a href="#"><img src="{{ asset('shopaholic') }}/images/instagram/5.png" alt="Instagram Image"></a>
                  <a href="#"><img src="{{ asset('shopaholic') }}/images/instagram/6.png" alt="Instagram Image"></a>
                  <a href="#"><img src="{{ asset('shopaholic') }}/images/instagram/7.png" alt="Instagram Image"></a>
                  <a href="#"><img src="{{ asset('shopaholic') }}/images/instagram/8.png" alt="Instagram Image"></a>
                </div><!-- /.widget-details -->
              </div><!-- /.widget -->
            </div>
